        ...
        e = (f.extend(a.prototype, {
                _constructor: function() {
                    var s = this,
                        ...
                        e = i.settings()[0],
                        t = f(m).innerWidth(),
                        e = (i.settings()[0]._responsive = this,
                ...
                _resize: function(n) {
                    ...
                    t.columns().eq(0).each(function(e, t) {
                        ...
                        h && (f(t.table().node()).trigger("responsive-resize.dt", [t, this.s.current]),
                ...
                _resizeAuto: function() {
                    ...
                    this.c.auto && -1 !== f.inArray(!0, f.map(o, function(e) {
                        ...
                        e.style.width = "auto",
                        n = s.columns().header().filter(function(e) {
                            return s.column(e).visible()
                        }).to$().clone(!1).css("display", "table-cell").css("width", "auto").css("min-width", 0),
                        f(i).append(f(s.rows({
                            page: "current"
                        }).nodes()).clone(!1)).find("th, td").css("display", ""),
                        (i = s.table().footer()) && (i = f(i.cloneNode(!1)).appendTo(e),
                            r = s.columns().footer().filter(function(e) {
                                return s.column(e).visible()
                    ...
                    display: (a.display = {
                        ...
                        modal: function(o) {
                            return function(e, t, n, i) {
                                ...
                                return o && o.header && f("div.dtr-modal-content").prepend("<h2>" + o.header(e) + "</h2>"),
                                    !0
                            }
                        }
                    }).childRow,
                            ...
                            return function(i, e, t) {
                                ...
                                f.each(t, function(e, t) {
                                    ...
                                    t.hidden && (n = t.className ? 'class="' + t.className + '"' : "",
                                        f("<li " + n + ' data-dtr-index="' + t.columnIndex + '" data-dt-row="' + t.rowIndex + '" data-dt-column="' + t.columnIndex + '"><span class="dtr-title">' + t.title + "</span> </li>").append(f('<span class="dtr-data"/>').append(r._childNodes(i, t.rowIndex, t.columnIndex))).appendTo(s),
                                        o = !0)
                                });
                                return !!o && s
                            }
